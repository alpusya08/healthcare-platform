...
public class AiAnalysisController {
    ...
    @PostMapping(value = "/analysis/{sessionId}/upload", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    @Operation(summary = "Upload medical document for analysis session")
    public ResponseEntity<Map<String, Object>> uploadFile(
            @PathVariable UUID sessionId,
            @RequestParam("file") MultipartFile file
    ) {
        Map<String, Object> result = aiServiceClient.uploadFile(sessionId, file);
